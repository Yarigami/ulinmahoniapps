...
import 'package:ulinmahoniapps/presentation/pages/comingsoon.dart';
...
import 'package:ulinmahoniapps/presentation/pages/propertytype.dart';
import 'package:ulinmahoniapps/presentation/widgets/mainlayout.dart';
  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: '/browse-all',
          builder: (context, state) => const BrowseAllPage(),
        ),
        GoRoute(
          path: '/comingsoon',
